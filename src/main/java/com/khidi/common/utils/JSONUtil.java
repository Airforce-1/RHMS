...
public class JSONUtil {
	...
	/**
	 * 传入一个字符串，返回        [abcd] 中的内容
	 * @param
	 * @return
	 */

	public static String getJson(String strings){
		int startposition = strings.indexOf('[');
		int endposition = strings.indexOf(']');
		return strings.substring(startposition,endposition+1);
	}
