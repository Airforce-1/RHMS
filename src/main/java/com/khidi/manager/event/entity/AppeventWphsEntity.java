 ...
 */
public class AppeventWphsEntity implements Serializable {
	...
	private String szxclgc;
	//创建时间
    @ApiModelProperty(value = "创建时间",dataType="Date",required = true,hidden = false)
	private Date createtime;
	//事件核实时间
    @ApiModelProperty(value = "事件核实时间",dataType="Date",required = true,hidden = false)
	private Date hstime;
	//事件核实的结果
    @ApiModelProperty(value = "事件核实的结果",dataType="String",required = true,hidden = false)
	private String sjhsjg;
	//事件的核实处理过程
    @ApiModelProperty(value = "事件的核实处理过程",dataType="String",required = true,hidden = false)
	private String sjhsclgc;
	//事件编号
	 ...
	 * 设置：事件的最新处理过程
	 */
	public void setSzxclgc(String szxclgc) {
		this.szxclgc = szxclgc;
	}
	/**
	 * 获取：事件的最新处理过程
	 */
	public String getSzxclgc() {
		return szxclgc;
	}
	/**
	 * 设置：创建时间
	 ...
	 * 设置：事件核实的结果
	 */
	public void setSjhsjg(String sjhsjg) {
		this.sjhsjg = sjhsjg;
	}
	/**
	 * 获取：事件核实的结果
	 */
	public String getSjhsjg() {
		return sjhsjg;
	}
	/**
	 * 设置：事件的核实处理过程
	 */
	public void setSjhsclgc(String sjhsclgc) {
		this.sjhsclgc = sjhsclgc;
	}
	/**
	 * 获取：事件的核实处理过程
	 */
	public String getSjhsclgc() {
		return sjhsclgc;
	}
	/**
	 * 设置：事件编号
