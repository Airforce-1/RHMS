 ...
 */
public class AppeventClEntity implements Serializable {
	...
	//事件处理时间
    @ApiModelProperty(value = "事件处理时间",dataType="Date",required = true,hidden = false)
	private Date dwtime;
	//事件处理的结果内容
    @ApiModelProperty(value = "事件处理的结果内容",dataType="String",required = true,hidden = false)
	private String dwresultContent;
	//事件的处理过程
	 ...
	 * 设置：事件处理时间
	 */
	public void setDwtime(Date dwtime) {
		this.dwtime = dwtime;
	}
	/**
	 * 获取：事件处理时间
	 */
	public Date getDwtime() {
		return dwtime;
	}
	/**
	 * 设置：事件处理的结果内容
	 */
	public void setDwresultContent(String dwresultContent) {
		this.dwresultContent = dwresultContent;
	}
	/**
	 * 获取：事件处理的结果内容
	 */
	public String getDwresultContent() {
		return dwresultContent;
	}
	/**
	 * 设置：事件的处理过程
	 */
