 ...
 */
@RestController
@RequestMapping("sttargetdetailtransmit")
@Api(value = "/StTargetdetailTransmit", description = "市级/县区级目标明细转发信息")
public class StTargetdetailTransmitController {
	@Autowired
	private StTargetdetailTransmitService stTargetdetailTransmitService;
	...
	public R list(@RequestParam(value="page",required=true) int page,
		...
		List<StTargetdetailTransmitEntity> stTargetdetailTransmitList = stTargetdetailTransmitService.queryList(query);
		int total = stTargetdetailTransmitService.queryTotal(query);
		
		PageUtils pageUtil = new PageUtils(stTargetdetailTransmitList, total, query.getLimit(), query.getPage());
	...
	public R info(@PathVariable("id") String id){
		StTargetdetailTransmitEntity stTargetdetailTransmit = stTargetdetailTransmitService.queryObject(id);
		
		return R.ok().put("data", stTargetdetailTransmit);
	}
	...
	public R save(@RequestBody StTargetdetailTransmitEntity stTargetdetailTransmit){
        verifyForm(stTargetdetailTransmit);
		stTargetdetailTransmitService.save(stTargetdetailTransmit);
		return R.ok();
	}
...
//	public R update(@RequestBody StTargetdetailTransmitEntity stTargetdetailTransmit){
//        verifyForm(stTargetdetailTransmit);
//		stTargetdetailTransmitService.update(stTargetdetailTransmit);
//		return R.ok();
//	}
...
//				stTargetdetailTransmitService.delete(strings[i]);
//		}
//		return R.ok();
//	}

    private void verifyForm(StTargetdetailTransmitEntity stTargetdetailTransmit){
	        if(StringUtils.isBlank(stTargetdetailTransmit.getTodeptid())){
