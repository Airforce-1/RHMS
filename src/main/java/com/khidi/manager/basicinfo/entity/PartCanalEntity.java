 ...
 */
public class PartCanalEntity implements Serializable {
    ...
    private String id;
    // 所属河流编码
    @ApiModelProperty(value = "所属河流编码", dataType = "String", required = true, hidden = false)
    private String canalId;
    // 所属河流名称
    @ApiModelProperty(value = "所属河流名称", dataType = "String", required = true, hidden = false)
    private String canalName;
    // 渠段名称
    @ApiModelProperty(value = "渠段名称", dataType = "String", required = true, hidden = false)
    private String name;
    // 渠段编码
    @ApiModelProperty(value = "渠段编码", dataType = "String", required = true, hidden = false)
    private String code;
    // 所属行政区划
    ...
    // 渠段起点位置
    @ApiModelProperty(value = "渠段起点位置", dataType = "String", required = true, hidden = false)
    private String riverStart;
    // 渠段终点位置
    @ApiModelProperty(value = "渠段终点位置", dataType = "String", required = true, hidden = false)
    ...
    private String endY;
    // 渠段长度
    @ApiModelProperty(value = "渠段长度", dataType = "String", required = true, hidden = false)
    ...
    //渠段警长（姓名）
    @ApiModelProperty(value = "渠段警长（姓名）", dataType = "String", required = true, hidden = false)
