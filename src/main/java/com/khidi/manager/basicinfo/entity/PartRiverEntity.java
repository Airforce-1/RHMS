 ...
 */
public class PartRiverEntity implements Serializable {
    ...
    // 河段名称
    @ApiModelProperty(value = "河段名称", dataType = "String", required = true, hidden = false)
    private String name;
    // 河流编码
    ...
    // 河段起点位置
    @ApiModelProperty(value = "河段起点位置", dataType = "String", required = true, hidden = false)
    private String riverStart;
    // 河段终点位置
    @ApiModelProperty(value = "河段终点位置", dataType = "String", required = true, hidden = false)
    ...
    private String endY;
    // 河段长度
    @ApiModelProperty(value = "河段长度", dataType = "String", required = true, hidden = false)
